...
namespace JSI
{
    ...
    {
        object Evaluate(RasterPropMonitorComputer rpmComp);
    }
    ...
    class CustomVariable : IComplexVariable
    {
        ...
        public object Evaluate(RasterPropMonitorComputer rpmComp)
        {
            ...
            bool evaluation = sourceVariables[0].IsInRange(rpmComp) ^ reverse[0];
            ...
            {
                bool nextValue = sourceVariables[i].IsInRange(rpmComp) ^ reverse[i];
