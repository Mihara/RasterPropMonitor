...
void main ()
{
  ...
  diffuse_1.w = (tmpvar_2.w * (_Color.w * _Opacity));
  diffuse_1.xyz = ((tmpvar_2.xyz * _Color.xyz) * diffuse_1.w);
...
void main ()
{
  ...
  tmpvar_2 = texture2D (_MainTex, xlv_TEXCOORD0);
  diffuse_1 = tmpvar_2;
  diffuse_1.w = (diffuse_1.w * (_Color.w * _Opacity));
  diffuse_1.xyz = ((diffuse_1.xyz * _Color.xyz) * diffuse_1.w);
  gl_FragData[0] = diffuse_1;
}
